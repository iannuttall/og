/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false src/worker-configuration.d.ts` (hash: aade12f33375d8b7d29b98b4016bea09)
// Runtime types generated with workerd@1.20260801.1 2026-07-09 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_HOSTS" | "ALLOW_SUBDOMAINS" | "ALLOWED_FORMATS" | "BROWSER_POOL_MAX" | "CACHE_TTL_SECONDS" | "ENABLE_PREFLIGHT" | "ENVIRONMENT" | "MAX_HTML_BYTES" | "MAX_NEW_URLS_PER_WINDOW" | "MAX_RENDERS_PER_WINDOW" | "PER_URL_COOLDOWN_SECONDS" | "REPOSITORY_URL" | "USAGE_WINDOW_SECONDS">> {}
}
